...
import { getMonthMatrix, isSameDay, fromLocalISO, toLocalISO, isToday } from '@/lib/utils/date';
import type { Event } from '@/types/event.types';
import { ProjectMonthEventChip } from './ProjectMonthEventChip';

const PROJECT_EVENT_COLOR = '#1a73e8';

interface ProjectMonthViewProps {
  anchor: Date;
  events: Event[];
...
export default function ProjectMonthView({
  anchor, events, onEventDoubleClick, onDayClick, onEventEdit,
  onCreateEvent, onEventChange, onEventDuplicate,
}: ProjectMonthViewProps) {
          ...
          {week.map((day, di) => {
            ...
            return (
              <div
                ...
                style={{
                  borderLeft: '1px solid #eee', padding: 4, minHeight: 90, cursor: 'pointer',
                  backgroundColor: hoveredDayKey === day.toDateString() ? '#e8f0fe' : inMonth ? '#fff' : '#fafafa',
              ...
              >
                <div
                  ...
                  style={{
                    fontSize: 13, fontWeight: 600, marginBottom: 4, display: 'inline-flex', alignItems: 'center',
