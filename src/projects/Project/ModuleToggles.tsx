...
export default function ModuleToggles({ modules, onToggle }: ModuleTogglesProps) {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 8, padding: 12, border: '1px solid #e0e0e0', borderRadius: 6 }}>
      <h4 style={{ margin: '0 0 4px 0', fontSize: 14, fontWeight: 600 }}>Módulos deste projeto</h4>
